...
DECLARE @Results TABLE (DatabaseName NVARCHAR(256), 
SchemaName NVARCHAR(256), 
TableName NVARCHAR(256), 
LastDBCCTableCheck DATETIME);
...
DECLARE cu CURSOR FOR SELECT [name] FROM sys.databases WHERE name <> 'tempdb' ORDER BY [name];
OPEN cu
FETCH cu INTO @DatabaseName;
